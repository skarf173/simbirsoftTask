...
public class TestValues {
    public static String TEST_LOGIN = "standard_user";
    public static String TEST_PASSWORD = "secret_sauce";
    ...
    public static String TEST_ERROR_MESSAGE = "Epic sadface: Username and password do not match any user in this service";
